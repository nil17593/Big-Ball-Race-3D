...
public class TrajectoryControllerAI : MonoBehaviour
{
    public AIPlayerMovement aIPlayerMovement;
    ...
    {
        RenderArc();
        velocity = aIPlayerMovement.ReturnDir() * aIPlayerMovement.ReturnThrowSpeed();
    }
